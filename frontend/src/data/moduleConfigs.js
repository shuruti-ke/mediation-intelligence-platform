/** Fallback module configs when backend has not been seeded. Enables full training content without running seed script. */
...
export const ONLINE_MEDIATION_CONFIG = {
  steps: [
    {
      id: "intro",
      type: "content",
