...
export const trainingAcademyApi = {
  ...
  listMediatorModules: (includeArchived) => api.get('/training/academy-admin/mediator-modules', { params: { include_archived: !!includeArchived } }),
  getMediatorModule: (id) => api.get(`/training/academy-admin/mediator-modules/${id}`),
  updateMediatorModule: (id, data) => api.patch(`/training/academy-admin/mediator-modules/${id}`, data),
  archiveMediatorModule: (id) => api.delete(`/training/academy-admin/mediator-modules/${id}`),
  unarchiveMediatorModule: (id) => api.patch(`/training/academy-admin/mediator-modules/${id}/unarchive`),
  ...
  updateQuiz: (id, data) => api.patch(`/training/academy-admin/quizzes/${id}`, data),
  assignModule: (data) => api.post('/training/academy-admin/assign-module', data),
...
export const calendarApi = {
  ...
  listFreeSlots: (params) => api.get('/calendar/free-slots', { params }),
